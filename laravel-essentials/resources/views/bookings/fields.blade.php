...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <div class="form-check">
            <input name="is_paid" type="checkbox" class="form-check-input" value="1" {{ old('is_paid') ?? $booking->is_piad ? 'checked' : '' }}/>
            {{-- <input type="checkbox" class="form-check-input" name="is_paid" value="1" {{ (isset($booking->is_paid)) && $booking->is_paid == 1 ? 'checked ' : ' '}}/> --}}
